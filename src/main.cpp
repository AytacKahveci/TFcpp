...
int main(int argc, const char * argv[])
{
    ...
    string base_folder = "/media/aytac/Tank/machine-learning/TFcpp/data/cats_and_dogs_small/cats_and_dogs_small/train";
    int batch_size = 20;
    ...
    base_folder = "/media/aytac/Tank/machine-learning/TFcpp/data/cats_and_dogs_small/cats_and_dogs_small/validation";
    ...
    cout << "**** Save model: \n";
    std::string filename = "/media/aytac/Tank/machine-learning/TFcpp/graphs/cat_dog.pb";
    /* s = model.FreezeSave(filename); */
    cout << "**** Save model: \n";
    return 0;
}
